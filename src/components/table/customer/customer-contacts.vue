...
export default {
  ...
  methods: {
    ...mapActions('contact', ['List', 'Show', 'Store', 'Update', 'Delete', 'DeleteMulti', 'Restore', 'RestoreMulti']),
    onRequest (props) {
      console.func('components/table/customer/contacts:methods.onRequest()', arguments)
    ...
    onAdd (props) {
      console.func('components/table/customer/contacts:methods.onAdd()', arguments)
    ...
    onSubmit (props) {
      console.func('components/table/customer/contacts:methods.onSubmit()', arguments)
      this.Store({
        customer: this.customer,
    ...
    onView (props) {
      console.func('components/table/customer/contacts:methods.onView()', arguments)
    ...
    onEdit (props) {
      console.func('components/table/customer/contacts:methods.onEdit()', arguments)
    ...
    onUpdate () {
      console.func('components/table/customer/contacts:methods.onUpdate()', arguments)
      this.Update({
        customer: this.customer,
        contact: this.data.contact
      }).then(() => {
    ...
    onDelete (props) {
      console.func('components/table/customer/contacts:methods.onDelete()', arguments)
    ...
    onDeleteMulti (props) {
      console.func('components/table/customer/contacts:methods.onDeleteMulti()', arguments)
    ...
    onRestore (props) {
      console.func('components/table/customer/contacts:methods.onRestore()', arguments)
    ...
    onRestoreMulti (props) {
      console.func('components/table/customer/contacts:methods.onRestoreMulti()', arguments)
      const ids = this.$_.map(this.selected, 'id')
